    ...
    return (
        <div className={styles.root}>
            <div className={styles.sidebar}>
                ...
                <IconButton onClick={() => setMenuOpen(!menuOpen)} className={styles.hamburgerMobile}>
                    {
                        menuOpen ? (
                            <ClearIcon />) :
                            (<MenuIcon />)
            ...
            <div className={styles.overlayContent}>
                <IconButton onClick={() => setMenuOpen(!menuOpen)} className={styles.hamburgerPc}>
                    {
                        menuOpen ? (
                            <ClearIcon />) :
                            (<MenuIcon />)
                ...
                </IconButton>
                {
                    menuOpen ? (
                        ...
                        (<>
                            <Typography variant="h4" component="h4" style={{ color: '#ffffffd1', fontWeight: '900' }} gutterBottom>
